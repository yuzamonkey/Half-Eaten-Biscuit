  ...
  return (
    <div>
      <nav className="home-page-navigation">
        <div>
          <a href="#home" className="home-navigation-link">Top</a>
          <a href="#about" className="home-navigation-link">About</a>
          <a href="#features" className="home-navigation-link">Features</a>
        </div>
        <div>
          <a href="/signin" className="home-navigation-link">Sign In</a>
          <a href="/signup" className="home-navigation-link">Sign Up</a>
        </div>
      </nav>
