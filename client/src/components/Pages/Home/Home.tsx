      ...
      <div className="scroll-container">
        <div className="scroll-page title-section" id="home">
          ...
          <div className="home-page-image-container">
            <img src={Musician1Svg} alt="" className="home-page-musician1-image" />
          </div>
        </div>
        ...
        <div className="scroll-page about-section" id="about">
          <h1>About</h1>
          <div className="home-page-image-container">
            <img src={Musician2Svg} alt="" className="home-page-musician2-image" />
          </div>
        ...
        <div className="scroll-page features-section" id="features">
          <div className="home-page-image-container">
            <img src={Pianosvg} alt="" className="home-page-piano-image" />
          </div>
          <h1>Features</h1>
