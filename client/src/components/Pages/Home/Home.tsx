...
import './Home.css'
import Guitarist from '../../../images/beard-musician-guitar-acoustic.jpeg'
...
const Home = () => {
  ...
  return (
    <div id="home" className="home-container">
      ...
      <div className="home-page-image-and-title-container">
        <div className="title-container">
          <h1 className="title">Hey freelancer, <br></br>you are needed!</h1>
        </div>
      </div>
      <div id="about" className="home-text-section-container about-section-container">
        <h1>About</h1>
      ...
      <div id="features" className="home-text-section-container features-section-container">
        <h1>Features</h1>
